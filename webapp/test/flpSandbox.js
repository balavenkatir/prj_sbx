			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsprjsbx-display": {
								"semanticObject": "nsprjsbx",
								"action": "display",
								"description": "A Fiori application from SBX.",
								"title": "Sales order List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.prjsbx",
									"url": sap.ui.require.toUrl("ns/prjsbx")
								}
							}
						}
					}
